...
plot_trend_z <- function(data, country_code, start_year = 2010, end_year = 2025) {
  ...
  # 6. Ensure metric labels match pivoted names
  metric_labels <- c(
    ...
    "lib_dem" = "Vdem: Liberal Democracy Index"
  )
  ...
  ggplot(country_long, aes(x = year, y = value, color = metric, group = metric)) +
    ...
    labs(title = paste0(country_code, ": SPI Pillars, SDG, and Democracy Trends (Z-Scores)"),
      x = "Year",
