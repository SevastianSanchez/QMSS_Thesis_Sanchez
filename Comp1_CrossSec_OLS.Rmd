...
inc_lev_interaction <- lm(sdg_overall ~ spi_comp + income_level + log_gdppc + population + year_fct, data = merged_2015)
...
reg_type4_interaction <- lm(sdg_overall ~ spi_comp + spi_comp*regime_type_4 + log_gdppc + year_fct,
                        data = merged_2015)
