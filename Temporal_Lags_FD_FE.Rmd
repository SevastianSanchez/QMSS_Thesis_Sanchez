...
#Temporal Lags 
In my study, I speculate that changes in SPI (comes first) produces subsequent changes in SDG progress (comes second). Based on current studies, it can take some time for implementation of statistical capacity stuctures to produce results.
...
# FD Analysis: SDG ~ SPI + subgroup(income group)
