...
fd_coef <- c(1.338, -0.887, -1.311)   # t-2, t-1, t
fd_se   <- c(0.451, 0.444, 0.371)     # corresponding SEs

twfe_coef <- c(0.712, -0.334, -0.449)  # t-2, t-1, t
twfe_se   <- c(0.550, 0.368, 0.525)    # corresponding SEs

# #### TESTINGGGGG #####
# fd_coef <- c(1.338, -0.887, -1.311) # Contemp, 1st lag, 2nd lag
# fd_se <- c(0.451, 0.444, 0.371)
# 
# twfe_coef <- c(0.712, -0.334, -0.449)
# twfe_se <- c(0.550, 0.368, 0.525)
########################
...
# Create data frames
periods <- c(0, 1, 2)
#period_labels <- c("Current (t)", "Lag t-1", "Lag t-2")
