...
income_data <- read_excel("data/raw_WDI_income_class_data/WDI_IncomeClass_Hist.xlsx", 
...
write.csv(income_data_long, "data/input_data/world_bank_income_classifications.csv", row.names = FALSE)
