...
# save the plot
ggsave("descriptive_stats_n_cross-tabulation/figures/correlation_matrix_main_vars.png", plot = correlation_plot, width = 5, height = 4, dpi = 300)
...
# save
ggsave("descriptive_stats_n_cross-tabulation/figures/correlation_matrix_sdg_disaggregated.png", plot = correlation_plot_sdg, width = 6, height = 5, dpi = 300)
```
...
# save 
ggsave("descriptive_stats_n_cross-tabulation/figures/partial_correlation_matrix_spi_sdg.png", 
       plot = matrix_spi_sdg, width = 7, height = 5, dpi = 300)
```
