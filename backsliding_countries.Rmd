...
aut_data <- event_data %>% filter(has_aut_ep == 1) ## experienced atleast 1 backsliding event 
dem_data <- event_data %>% filter(has_dem_ep == 1) ## experienced atleast 1 democratizing event 
```
