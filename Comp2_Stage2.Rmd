...
```{r}
# Contemporaneous Effect: SDG ~ SPI + DI
fd_sdg_spi <- plm(formula = sdg_overall ~ spi_comp + di_score + log_gdppc + income_level_recoded, 
               model = "fd", 
               index = c("country_code", "year"),
               data = fd_data)
...
# Adding Lag1: SPI ~ DI
fd_sdg_spi_L1 <- plm(formula = sdg_overall ~ spi_comp + dplyr::lag(spi_comp, 1) + di_score + dplyr::lag(di_score, 1) + log_gdppc + income_level_recoded, 
               model = "fd", 
               index = c("country_code", "year"),
               data = fd_data)
...
# Adding Lag2: SPI ~ DI
fd_sdg_spi_L2 <- plm(formula = sdg_overall ~ spi_comp + dplyr::lag(spi_comp, 1) + dplyr::lag(spi_comp, 2) + di_score + dplyr::lag(di_score, 1) + dplyr::lag(di_score, 2) + log_gdppc + income_level_recoded, 
               model = "fd", 
               index = c("country_code", "year"),
               data = fd_data)
...
# Adding Lag1: SPI ~ DI
fe_sdg_spi_L1 <- plm(formula = sdg_overall ~ spi_comp + dplyr::lag(spi_comp, 1) + di_score + dplyr::lag(di_score, 1) + log_gdppc + income_level_recoded, 
               model = "within", 
               index = c("country_code", "year"),
               data = panel_data, 
               effect = "twoways")
...
# Adding Lag2: SPI ~ DI
fe_sdg_spi_L2 <- plm(formula = sdg_overall ~ spi_comp + dplyr::lag(spi_comp, 1) + dplyr::lag(spi_comp, 2) + di_score + dplyr::lag(di_score, 1) + dplyr::lag(di_score, 2) + log_gdppc + income_level_recoded, 
               model = "within", 
               index = c("country_code", "year"),
               data = panel_data, 
               effect = "twoways")
