...
merged <- df_years2.0(2004, 2024) %>% 
  select(country_name, country_code, year, year_fct, sdg_overall, spi_comp, sci_overall, di_score, regime_type_2, regime_type_4, regch_event, aut_ep, dem_ep, income_level, income_level_lab, gini, log_gdppc, population)
