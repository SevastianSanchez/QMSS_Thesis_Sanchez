...
merged <- df_years(yr1=2004) %>% 
  select(country_name.x, country_code, year, year_fct, sdg_overall, spi_comp, sci_overall, di_score, income_level, income_level_lab, gini, log_gdppc, population)
```
