...
sci <- read_csv("~/Desktop/OneDrive/OneDrive/QMSS Thesis/Datasets/SCI_All_Dim_TS.csv", col_types = cols(`Time Code` = col_skip())) 
...
, Country Code, Time, Overall Average [IQ.SCI.OVRL], Source data assessment of statistical capacity (scale 0 - 100) [IQ.SCI.SRCE], Periodicity and timeliness assessment of statistical capacity (scale 0 - 100) [IQ.SCI.PRDC], Methodology assessment of statistical capacity (scale 0 - 100) [IQ.SCI.MTHD], everything())
